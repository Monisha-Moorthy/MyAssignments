...
public class PVRCinemas {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("name")).sendKeys("Moni");
		driver.findElement(By.name("email")).sendKeys("moni@testleaf.com");
		driver.findElement(By.name("mobile")).sendKeys("9876543231");
